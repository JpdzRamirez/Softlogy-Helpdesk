...
class __TwigTemplate_2aa6e6f2f3ab42d0eb50c83a40b46bc1 extends Template
{
    private $source;
    private $macros = [];
...
<h2 class=\"mx-auto text-center\" style=\"color:white;\">{{ __('Login to your account') }}</h2>
<label class=\"form-label\" for=\"login_password\" style=\"color:white;\">
   Usuario
</label>
<div class=\"input-group mb-3 input-group-prepend\">
   <span class=\"input-group-text\"><i class=\"fas fa-user\"></i></span>
   <input type=\"text\" class=\"form-control\" id=\"login_name\" name=\"{{ namfield }}\" placeholder=\"Usuario\" tabindex=\"1\" />
 </div>
 ...
 <div class=\"input-group mb-3 input-group-prepend\">
   <span class=\"input-group-text\"><i class=\"fas fa-key\"></i></span>
   <input type=\"password\" class=\"form-control\" id=\"login_password\" name=\"{{ pwdfield }}\" placeholder=\"Contraseña\" autocomplete=\"off\" tabindex=\"2\" />
 </div>
...
{% if config('display_login_source') %}
   <div class=\"mb-3\">
      <label class=\"form-label\" style=\"color:white;\" for=\"dropdown_auth{{ rand }}\">{{ __('Login source') }}</label>
      {{ auth_dropdown_login|raw }}
   </div>
{% endif %}

{% if config('login_remember_time') %}
   <div class=\"mb-2 span-centered\">
      <label class=\"form-check\" for=\"login_remember\" style=\"color:white;\">
         <input type=\"checkbox\" style=\"background-color:#0a66c2\" class=\"form-check-input\" id=\"login_remember\" name=\"{{ rmbfield }}\" {{ config('login_remember_default') ? 'checked' : '' }} />
...
{% endblock %}
", "pages/login.html.twig", "C:\\laragon\\www\\glpi\\templates\\pages\\login.html.twig");
    }
}
