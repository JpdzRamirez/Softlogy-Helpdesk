...
class NotificationTargetTest extends DbTestCase
{
    public function testGetSubjectPrefix()
    {
        ...
        $this->assertEquals("[Softlogy] ", $ntarget_parent->getSubjectPrefix());
        $this->assertEquals("[Softlogy] ", $ntarget_child_1->getSubjectPrefix());
        $this->assertEquals("[Softlogy] ", $ntarget_child_2->getSubjectPrefix());
